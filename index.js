(function () {
  ...
  const CIRCLE_IMAGES = {
    PREV: './images/circle-prev-day.png',
    CURRENT: './images/circle-current-day.png',
    FUTURE: './images/circle-future-day.png',
  };

  const CIRCLE_LIGHT_IMAGE = './images/circle-light-current-day.png';
  const BLUR_CIRCLES_IMAGE = './images/blur-circles.png';
